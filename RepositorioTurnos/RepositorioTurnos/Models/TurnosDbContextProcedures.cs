...
namespace RepositorioTurnos.Models
{
    public partial class TurnosDbContext
    {
        private ITurnosDbContextProcedures _procedures;

        public virtual ITurnosDbContextProcedures Procedures
        {
            get
            {
                if (_procedures is null) _procedures = new TurnosDbContextProcedures(this);
                return _procedures;
            }
            set
            {
        ...
        public ITurnosDbContextProcedures GetProcedures()
        {
            return Procedures;
        }
    ...
    public partial class TurnosDbContextProcedures : ITurnosDbContextProcedures
    {
        private readonly TurnosDbContext _context;

        public TurnosDbContextProcedures(TurnosDbContext context)
        {
            _context = context;
        }
